...
Diagrama y documentación del proceso de ventas al IMSS (desplazamiento en unidades médicas).
...
| [[ASK-VEN-FOR-002 Plan de Trabajo (formato)\|ASK-VEN-FOR-002]] | Formato | Plan de trabajo |
...
| [[ASK-VEN-DOE-001 Reporte de Incidente\|ASK-VEN-DOE-001]] | Formato | Reporte de incidente (Formato de Lefarma) |
