# Diagrama de proceso y documentación del proceso de Ventas IMSS

> Fuente: `pdf/Ventas/Diagrama del proceso de ventas.pdf`
> Código: ASK-VEN-DPD-001 · Versión: 01 · Fecha: 24-jun-2021
...
| GV-IMSS | Gerente de ventas IMSS |
| GRI | Gerente de relaciones institucionales |
| EV-IMSS | Ejecutivo de ventas |
...
| ASK-VEN-IDT-001 | Instructivo de trabajo | Para elaborar el plan de trabajo |
| ASK-VEN-IDT-002 | Instructivo de trabajo | Para visitar las unidades médicas |
| ASK-VEN-IDT-003 | Instructivo de trabajo | Para reportar desplazamiento y venta |
| ASK-VEN-FOR-001 | Formato | Objetivos de ventas |
| ASK-VEN-FOR-002 | Formato | Distribución del presupuesto |
| ASK-VEN-FOR-003 | Formato | Plan de trabajo |
| ASK-ADM-FOR-001 | Formato | Solicitud de viáticos |
| ASK-VEN-DOE-001 | Formato | Reporte de incidente (Formato de Lefarma) |
...
| Puesto | Nombre | Rol |
|--------|--------|-----|
| Gerente de ventas IMSS | Lic. Martín Evangelista Cruz | Elaboró |
