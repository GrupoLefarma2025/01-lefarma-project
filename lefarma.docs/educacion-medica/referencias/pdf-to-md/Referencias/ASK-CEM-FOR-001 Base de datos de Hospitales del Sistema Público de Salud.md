...
# Base de datos de Hospitales del Sistema Público de Salud
...
| Campo | Valor |
|-------|-------|
| Código | ASK-CEM-FOR-001 |
| Nombre | Base de datos de Hospitales del Sistema Público de Salud |
