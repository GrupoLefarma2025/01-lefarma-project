...
# Depósito Box Lunch para Talleres Médicos IMSS y Descentralizados
...
| Campo | Valor |
|-------|-------|
| Código | ASK-TES-FOR-001 |
| Nombre | Depósito Box Lunch para Talleres Médicos IMSS y Descentralizados |
| Área | Administración |
