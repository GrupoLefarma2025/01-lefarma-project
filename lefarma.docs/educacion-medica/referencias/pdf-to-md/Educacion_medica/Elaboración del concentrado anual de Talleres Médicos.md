# Instrucción de trabajo para elaborar el concentrado anual de Talleres Médicos

> Fuente: `pdf/Educacion_medica/Elaboración del concentrado anual de Talleres Médicos.pdf`
> Código: ASK-CEM-IDT-002 · Versión: 02 · Fecha: 14-mar-2024
...
Esta instrucción de trabajo inicia desde que la Coordinación de Educación Médica solicita la base de datos de los hospitales al ejecutivo de estadística, hasta que el Coordinador de Educación Médica presenta la base de datos analizada y filtrada junto con el Programa de talleres médicos a realizar en el año a la Dirección Corporativa y obtiene su autorización.
...
| 5.3 | Coordina reunión en la tercera semana de noviembre con Gerentes de Ventas, Gerente General y Ejecutivo de Estadística para elaborar la "Base de datos de Hospitales para Talleres Médicos" y el "Programa anual de Talleres Médicos" | ● | | ASK-CEM-FOR-001 · ASK-CEM-FOR-002 · ASK-CEM-FOR-003 |
| 5.4 | Presenta a Dirección Corporativa los documentos y obtiene su autorización | ● | | — |
...
8. Si el hospital cuenta con Servicio Integral de Anestesia (SIA)
...
1. Ejecutivo de Estadística presenta las bases de datos de cada gerencia.
2. Gerentes de Ventas analizan y determinan los hospitales a visitar con base en los siguientes criterios:
   ...
   - 1.7. Registran los hospitales que se visitarán en el transcurso del año en el formato "Base de Datos de Hospitales para Talleres Médicos"
...
5. Elaboran el "Programa anual de Talleres Médicos" del próximo año, considerando:
...
> **Nota:** Si durante el año se realizan acuerdos comerciales con algún SIA que requiera talleres médicos, se deberá actualizar y autorizar el programa. El programa deberá revisarse trimestralmente para supervisar el avance de hospitales ya visitados y actualizar la programación.
...
2. Base de datos de Hospitales para talleres Médicos
3. Programa de Talleres Médicos
...
flowchart TD
    ...
    P51["Coordinador Ed. Médica:\nSolicita por correo electrónico\n(1ª semana de noviembre) la\nbase de datos actualizada de\nHospitales del Sistema Público\nde Salud al Ejecutivo de Estadística\n(datos: nombre, estado, municipio,\ninstitución, nivel, quirófanos, SIA,\nestimación anestesias)"]

    P52["Ejecutivo de Estadística:\nRecibe correo y en 5 días hábiles\nprepara la base de datos (pasos\nAnexo 2). Envía ASK-CEM-FOR-001\nal Coordinador de Educación Médica"]

    P53["Coordinador Ed. Médica:\nCoordina reunión (3ª semana\nde noviembre) con Gerentes de\nVentas, Gerente General y\nEjecutivo de Estadística"]

    R531["Ejecutivo de Estadística:\nPresenta bases de datos\nde cada gerencia"]

    R532["Gerentes de Ventas:\nAnalizan y determinan hospitales\na visitar (criterios: Pareto 70/30,\ndistancias, tipo de hospital, SIA,\ninseguridad, experiencia).\nRegistran en ASK-CEM-FOR-002"]

    R533["Equipo:\nDetermina frecuencia de talleres\npor hospital según demanda\nde productos"]

    R534["Equipo:\nEstablece total de talleres al año\n= No. hospitales × 1.5"]

    R535["Equipo:\nElabora Programa anual de\nTalleres Médicos (ASK-CEM-FOR-003)\nconsiderando plan anual de ventas,\nproductos a promocionar y\nproductos para licitación"]

    R536["Equipo:\nFirman de conformidad\nlos formatos correspondientes"]

    NOTA["NOTA: Si surgen acuerdos SIA\nen el año → actualizar y\nautorizar el programa.\nRevisión trimestral del avance."]

    P54["Coordinador Ed. Médica:\nPresenta a Dirección Corporativa\ny obtiene autorización de:\n1. Base de datos Hospitales\n   Sistema Público de Salud\n2. Base de datos Hospitales\n   para Talleres Médicos\n3. Programa de Talleres Médicos"]

    FIN([FIN])

    INICIO --> P51 --> P52 --> P53
    P53 --> R531 --> R532 --> R533 --> R534 --> R535 --> R536
    R536 --> NOTA
    NOTA --> P54 --> FIN
```
...
|----|--------|--------|-------------|------------------|
| 1 | ASK-CEM-FOR-001 | Base de datos de Hospitales del Sistema Público de Salud | Coordinador de Educación Médica | Físico y Electrónico |
| 2 | ASK-CEM-FOR-002 | Base de datos de Hospitales para talleres Médicos | Coordinador de Educación Médica | Físico y Electrónico |
| 3 | ASK-CEM-FOR-003 | Programa anual de talleres Médicos | Coordinador de Educación Médica | Físico y Electrónico |
...
*(Ver formato ASK-CEM-FOR-002)*

### Anexo 4. Programa anual de Talleres Médicos

*(Ver formato ASK-CEM-FOR-003)*
