...
Use template from `/home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
