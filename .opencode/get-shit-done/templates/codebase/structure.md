...
- Usage: Reference from command with `@/home/zury/workplace/01-lefarma-project/.opencode/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/zury/workplace/01-lefarma-project/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/zury/workplace/01-lefarma-project/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
